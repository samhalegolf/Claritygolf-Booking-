...
export default function OptixIntegrationPanel() {
  ...
  async function saveResources() {
    ...
    const config = Object.fromEntries(services.map((service) => {
      ...
      return [service.id, { enabled: Boolean(standard || left), leftHanded: false, preferredResourceIds: standard?.resourceIds || [], leftHandedResourceIds: left?.resourceIds || [] }];
    }));
      ...
      <div className="optix-native-body">
        {tab === "setup" ? <>
          ...
          <div className="optix-native-grid">
            ...
            <label>Bay booking<input readOnly value="Manual" /></label>
          </div>
